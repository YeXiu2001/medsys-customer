                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5">
                                        <a href="index.html" class="d-block card-logo">
                                            <img src="{{url('assets/images/logo-dark.png')}}" alt="" height="18" class="card-logo-dark">
                                            <img src="{{url('assets/images/logo-light.png')}}" alt="" height="18" class="card-logo-light">
                                        </a>
                                    </div>
                                    <div class="my-auto">
