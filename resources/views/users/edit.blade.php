        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('users.update', $user->id) }}" method="post">
                    ...
                    <div class="mb-3 row">
                        <label for="password_confirmation" class="col-md-2 col-form-label text-md-end text-start">Confirm Password</label>
                        <div class="col-md-5">
                    ...
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-1 offset-md-6 btn btn-primary" value="Update User">
                    </div>
